...
All projects must use a single GitHub repository in the [UW-Math-AI org](https://github.com/uw-math-ai). A single branch is recommended. Each member should be added as a collaborator. To ensure code reuse, push often; it also helps minimize merge conflicts. Add the end-of-quarter poster to the README.
